      ...
      return (
        ...
        <div className="redeem">
          ...
          <div className="center-div">
            ...
            <img src={PointsIcon} alt="Click here to redeem your points" className="redeem-icon mt-5" />
            <h1 className="font-blue mt-2">Prize Time!</h1>
            <div className="points-box m-4 py-4">
                <h2 className="font-blue nunito-font">You have <br />
                    250 points
                </h2>
            </div>
            <p>Choose your prize below</p>
                ...
                <Row className="my-4" onClick={this.toggleHidden.bind(this)}>
                    <Col xs={6}>
                        ...
                        <img src={Soda} alt="fountain drink" width="100%" className="prize-item"  />
                    </Col> 
                    <Col xs={6} className="text-left">
                        <h3 className="nunito-font font-blue">Fountain Drink</h3>
                        
                        <h4 className="font-grey"> 
                            <img src={CoinIcon} alt="Points" className="mr-1" width="22px" />
                            70 points
                        </h4>
                    </Col>
                </Row>
                <Row className="my-4" onClick={this.toggleHidden.bind(this)}>
                    <Col xs={6}>
                        {!this.state.isHidden && <Check />}
                        <img src={Popcorn} alt="popcorn tub" width="100%" className="prize-item" />
                    </Col> 
                    <Col xs={6} className="text-left">
                ...
                <Row className="my-4" onClick={this.toggleHidden.bind(this)}>
                    <Col xs={6}>
                        {!this.state.isHidden && <Check />}
                        <img src={Pizza} alt="pizza slice" width="100%" className="prize-item" />
                    </Col> 
                    <Col xs={6} className="text-left">
                ...
                <button
                className="redeem-btn nunito-font mb-4">Redeem!</button>
